...
let coletarInfo = require('readline-sync');
// ------------------------------------------------------------
...
// → Seu código aqui:
const cadastro = {
    nome: coletarInfo.question('Nome: '),
    idade: coletarInfo.questionInt('Idade: '),
    profissâo: coletarInfo.question('Profissao: '),
    cidade: coletarInfo.question('Cidade: '),
    javaScript: coletarInfo.keyInYN('Gosta de programar em JavaScript? '),
        comidaFav: [
            coletarInfo.question('Quais suas comidas favoritas? '),
        ],
        pessoasQueMoram: [ 
        {
            nome: coletarInfo.question("Nome de uma pessoa que mora com voce: "),
            idade: coletarInfo.questionInt("Idade dessa pessoa: ")
        },
        {
            nome: coletarInfo.question("Nome de outra pessoa: "),
            idade: coletarInfo.questionInt("Idade dessa pessoa: ")
        }
        ]
};
...
console.log(`Nome: ${cadastro.nome}.
    ...
    Profissao: ${cadastro.profissão} em ${cadastro.cidade}.
    Gosta de JS? ${cadastro.javaScript}.
    Comidas favoritas: ${cadastro.comidaFav}.
    Pessoas que moram com voce: 
    ${cadastro.pessoasQueMoram[0].nome}(${cadastro.pessoasQueMoram[0].idade}) e ${cadastro.pessoasQueMoram[1].nome}(${cadastro.pessoasQueMoram[1].idade}).`);
...
// → Seu código aqui:
const usuarios = {
    nome: coletarInfo.question("Digite o nome da pessoa: "),
    idade: coletarInfo.questionInt("Digite a idade dessa pessoa: "),
    enderecoCompleto: {
        estado: coletarInfo.question("Digite o estado: "),
        cidade: coletarInfo.question("Digite a cidade: "),
        rua: coletarInfo.question("Digite a rua: ")
    }
