...
let peso = dados.questionInt("Digite seu peso atual em Kg: ")
let altura = dados.questionFloat("Digite sua altura em M: ")
// B)
let pessoa = {
    nome,
    peso,
...
// F)
console.log(`${pessoa.nome}, seu IMC é: ${imc.toFixed(2)} - ${classImc}`)
...
// B)
let senhaC = dados.questionInt("Informe a senha de 4 digitos: ")
// C)
...
// → Seu código aqui:
let nomeEspectador = dados.question("Nome do espectador: ")
let idadeEspectador = dados.questionInt("Idade: ")
console.log("Classificação indicativa:")
console.log('0 – Livre');
console.log('10 – 10 anos');
console.log('12 – 12 anos');
console.log('14 – 14 anos');
console.log('16 – 16 anos');
console.log('18 – 18 anos');
let classificacao = dados.questionInt("Digite a classificação do filme desejada: ")
// B)
let cinema = {
    nomeEspectador,
    idadeEspectador,
...
if(classificacao === 0){
    ...
    classificacao === 18
    console.log(`${cinema.nomeEspectador} não pode assistir. Classificação: <classificação> anos.`);
}
console.log("_______________________________");
...
`);
// A)
let nomeP = dados.question("Nome: ")
let numP = dados.questionInt("Número do lanche desejado: ")
let comboN = dados.keyInYN("Caso não seja o combo, deseja batata frita? ")
let comboN1 = dados.keyInYN("")
console.log("_______________________________");
