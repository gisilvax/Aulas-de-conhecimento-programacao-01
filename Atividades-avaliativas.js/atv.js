...
// → Seu código aqui:
let nomeViajante = dados.question("Nome: ")
let idadeViajante = dados.questionInt("Idade: ")

console.log("===ORÇAMENTO===");
console.log("1) Econômico");
console.log("2) Moderado");
console.log("3) Luxo");
let orcamento = dados.questionInt("Orcamento: ")
...
let resp1 = dados.questionInt("Resposta: ")
//
let resp2;
if(resp1 === 1){
    ...
    resp2 = dados.questionInt("Escolha a opcao: ")
    }else if(resp1 === 2){
        console.log("Você prefere:");
...
if(resp1 === 1 && resp2 === 1){
    ...
    resp3 = dados.questionInt("Escolha a opcao desejada: ")
    ...
    console.log("Passe para a proxima etapa!");
...
console.log(`|   Orçamento: ${orcamento01}                  `);
